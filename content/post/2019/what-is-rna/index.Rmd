...
Riboucleic Acid (RNA) is a type of molecule in cells that "transmits" messages from genes encoded in DNA to their protein form. RNA is made by specialize cellular machines that read the DNA code and create an RNA copy. The "NA" in DNA and RNA indicates they both are created in the nucleus, but unlike DNA, RNA can be found throughout the cell, performing many functions.
...
We have established a [fund at the CU Foundation](https://giving.cu.edu/fund/biochemistry-and-molecular-genetics-discovery-fund) to collect donations. Funding from the community will enable us to build on several important efforts within the RBI:

- Training the next generation of researchers in "big data" related to RNA biology.
